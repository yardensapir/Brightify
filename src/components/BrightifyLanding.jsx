...
const BrightifyLanding = () => {
  ...
  const ServiceContent = ({ label, title, description, buttonText, animationVariant }) => {
    const ref = React.useRef(null);
    const isInView = useInView(ref, { once: false, amount: 0.3 });
...
// Helper components moved inside the main component to access animation variants